...
import { showToast, formatPrice, requireAuth, getCartCount, updateCartBadge } from './utils.js';
...
async function loadProducts() {
  ...
  grid.innerHTML = '<div class="loading-grid" style="display:flex;padding:80px 0;"><span></span><span></span><span></span></div>';
...
function setupFilters() {
  // Category nav (subcategory links + top-level links)
